...
Module[{cst, data, issues, syntaxIssues, issuesToReturn, formatIssues},
  cst = cstIn;
  ...
  issuesToReturn = issuesToReturn ~Join~ (InspectionObject[#[[1]], #[[2]], #[[3]], <|#[[4]], ConfidenceLevel -> 1.0|>]& /@ formatIssues);
